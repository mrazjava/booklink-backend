...
insert into bl_user (id, active, email, f_name, l_name, last_login_on, pwd, auth_token, auth_token_expiry, origin_id) values (3, 1, 'ant@booklink.test', 'Amazing', 'Ant', null, 'd0457bd5b5ed542ed1a4a295202d7ed527791071a9acfc202ca850381a2f38ff3224bb37db1136e0', null, null, 1);
